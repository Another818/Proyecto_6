...
{
    public partial class frmTipoPlanta : Form
    {
        ...
        private void frmTipoPlanta_Load(object sender, EventArgs e)
        {
            myEstado = "E";
            SetearControles();
            ControlarBotones();
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            DialogResult myRespuesta = MessageBox.Show("Desea eliminar el Tipo de Planta " + myTipoPlanta.pSNombre,
            ...
            if (myRespuesta == DialogResult.Yes)
            {
                ...
                sCadenaSQL = "delete TIPOS_PLANTAS where Cod_Tipo_Planta = " + myTipoPlanta.pICod_Tipo_Planta;
                // Ejecuto la consulta
            ...
            myTipoPlanta.pSNombre = txtbNombreTipoPlanta.Text;
        }
        #endregion
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            switch (myEstado)
            {
                ...
                case "A":
                    ...
                    sCadenaSQL = "insert into TIPOS_PLANTAS(Nombre) values ('" + myTipoPlanta.pSNombre + "')";
                    // Ejecuto la consulta
                    clsDatos.GetSql(sCadenaSQL);
                ...
                case "B":
                    CargarGrilla(Convert.ToString(myTipoPlanta.pICod_Tipo_Planta), "Cod_Tipo_Planta");
                    myEstado = "E";
                    SetearControles();
                    ControlarBotones();
                    break;
                ...
                case "M":
                    ...
                    sCadenaSQL = "update TIPOS_PLANTAS set Nombre = '" + myTipoPlanta.pSNombre
                       + "' where Cod_Tipo_Planta = " + myTipoPlanta.pICod_Tipo_Planta;
        ...
        private void txtbBuscar_TextChanged(object sender, EventArgs e)
        {
            ...
            CargarGrilla(txtbBuscar.Text, "Nombre");
        }
        ...
        private void SetearControles()
        {
            ...
            {
                case "A":
                    txtbNombreTipoPlanta.Enabled = true;
                    dgvTipoPlantas.Height = 400;
                    dgvTipoPlantas.Enabled = false;
                ...
                case "B":
                    txtbNombreTipoPlanta.Enabled = false;
                    dgvTipoPlantas.Height = 270;
                    dgvTipoPlantas.Enabled = true;
        ...
        private void CargarGrilla(string Buscar, string Campo)
        {
            ...
            if (Buscar == "")
            {
                sMyCadenaSQL = "select * from Vista_TipoPlantas";
            }
            //Si estoy buscando
            else
            {
                sMyCadenaSQL = "select * from Vista_TipoPlantas where " + Campo + " like '" + Buscar + "%' order by " + Campo;
            }
        ...
        private void Grilla_A_Objeto()
        {
            ...
            myTipoPlanta.pICod_Tipo_Planta = Convert.ToInt32(dgvTipoPlantas.CurrentRow.Cells["Cod_Tipo_Planta"].Value);
            myTipoPlanta.pSNombre = Convert.ToString(dgvTipoPlantas.CurrentRow.Cells["Nombre"].Value);
        ...
        private void Objeto_A_Controles()
        {
            ...
            txtbNombreTipoPlanta.Text = myTipoPlanta.pSNombre;
        }
        ...
        private void Controles_A_Objeto()
        {
            ...
            switch (myEstado)
            {
                ...
                case "A":
                    ...
                    myTipoPlanta.pICod_Tipo_Planta = 0;
                    break;
                // Si esta modificando 
                case "M":
