...
{
    public partial class frmCondicionesIva : Form
    {
        ...
        private void frmCondicionesIva_Load(object sender, EventArgs e)
        {
            myEstado = "E";
            SetearControles();
            ControlarBotones();
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            DialogResult myRespuesta = MessageBox.Show("Desea eliminar la Condición Iva: " + myCondicionIva.pSDescripcion,
            ...
            if (myRespuesta == DialogResult.Yes)
            {
                ...
                sCadenaSQL = "delete CONDICIONES_IVA where Cod_Condicion_Iva = " + myCondicionIva.pICod_Condicion_Iva;
                // Ejecuto la consulta
            ...
            myCondicionIva.pSDescripcion = txtbCondiciónIva.Text;
        }
        #endregion
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            switch (myEstado)
            {
                ...
                case "A":
                    ...
                    sCadenaSQL = "insert into CONDICIONES_IVA(Descripcion) values ('" + myCondicionIva.pSDescripcion + "')";
                    // Ejecuto la consulta
                    clsDatos.GetSql(sCadenaSQL);
                ...
                case "B":
                    CargarGrilla(Convert.ToString(myCondicionIva.pICod_Condicion_Iva), "Cod_Condicion_Iva");
                    myEstado = "E";
                    SetearControles();
                    ControlarBotones();
                    break;
                ...
                case "M":
                    ...
                    sCadenaSQL = "update CONDICIONES_IVA set Descripcion = '" + myCondicionIva.pSDescripcion
                       + "' where Cod_Condicion_Iva = " + myCondicionIva.pICod_Condicion_Iva;
        ...
        private void SetearControles()
        {
            ...
            {
                case "A":
                    txtbCondiciónIva.Enabled = true;
                    dgvCondicionIva.Height = 400;
                    dgvCondicionIva.Enabled = false;
                ...
                case "B":
                    txtbCondiciónIva.Enabled = false;
                    dgvCondicionIva.Height = 270;
                    dgvCondicionIva.Enabled = true;
        ...
        private void CargarGrilla(string Buscar, string Campo)
        {
            ...
            if (Buscar == "")
            {
                sMyCadenaSQL = "select * from Vista_CondicionesIva";
            }
            //Si estoy buscando
            else
            {
                sMyCadenaSQL = "select * from Vista_CondicionesIva where " + Campo + " like '" + Buscar + "%' order by " + Campo;
            }
        ...
        private void Grilla_A_Objeto()
        {
            ...
            myCondicionIva.pICod_Condicion_Iva = Convert.ToInt32(dgvCondicionIva.CurrentRow.Cells["Cod_Condicion_Iva"].Value);
            myCondicionIva.pSDescripcion = Convert.ToString(dgvCondicionIva.CurrentRow.Cells["Descripcion"].Value);
        ...
        private void Objeto_A_Controles()
        {
            ...
            txtbCondiciónIva.Text = myCondicionIva.pSDescripcion;
        }
        ...
        private void Controles_A_Objeto()
        {
            ...
            switch (myEstado)
            {
                ...
                case "A":
                    ...
                    myCondicionIva.pICod_Condicion_Iva = 0;
                    break;
                // Si esta modificando 
                case "M":
